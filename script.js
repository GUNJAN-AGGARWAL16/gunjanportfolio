...
let mainPara = document.querySelector("#mainn p");
...
let contactH1 = document.querySelector("#contactt h1");
let contactForm = document.querySelector("#contact form");
let contactAnker = document.querySelector("#contact a");

function handleOpacitty (opacityOne,opacityzero1, opacityZero2,opacityZero3) {
...
aboutLink.addEventListener('click', function() {
    ...
    handleAnimation(aboutH1,aboutPara,aboutnAnker);
});
...
let closeButton = document.querySelector('.class-modal')
